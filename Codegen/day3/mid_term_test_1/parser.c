...
void compileAssignSt(void)
{
  ...
  do {
    ...
    if(previousVarType == NULL) 
    {
      previousVarType = varType;
    } else 
    {
      if(compareType(previousVarType, varType) == 0) 
      {
...
void compileCallSt(void)
{
  ...
  {
    compileArguments2(proc->procAttrs->paramList);
...
void compileArguments2(ObjectNode *paramList) {
